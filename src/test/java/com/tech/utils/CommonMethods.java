...
import com.tech.testbase.PageInitializer;

public class CommonMethods extends PageInitializer {
	// these all are Selenium common methods
	/**
	...
	public static WebDriverWait getWaitObject() {
		WebDriverWait wait = new WebDriverWait(driver, Constss.EXPLICIT_WAIT_TIME);
	...
	public static byte[] takeScreenshot(String filename) {
		...
		String destination = Constss.SCREENSHOT_FILEPATH + filename + getTimeStamp() + ".png";
